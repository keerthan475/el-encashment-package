                ...
                <tr key={row.id}>
                  ...
                  <td>
                    <div className="actions-row">
                      <button type="button" onClick={() => window.open(`http://localhost:8080/api/cgeis/bill-report/${row.id}`, "_blank")}>View Bill</button>
                      <button type="button" onClick={() => window.open(`http://localhost:8080/api/cgeis/it-report?billNo=${encodeURIComponent(row.billNo)}`, "_blank")}>View IT Report</button>
                    </div>
                  </td>
                </tr>
              ))}
